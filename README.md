...
- `republic doctor --format all` exports JSON and Markdown operator snapshots under `.ai-republic/reports/doctor.json` and `.ai-republic/reports/doctor.md`.
...
- `republic status --format all` exports JSON and Markdown status snapshots under `.ai-republic/reports/status.json` and `.ai-republic/reports/status.md`.
