...
- `repoagents dashboard --tui` opens an interactive terminal dashboard with `Runs`, `Reports`, `Ops`, `Handoffs`, and `Retention` sections. Use `1-5`, arrow keys, `Tab`, `r`, and `q` to navigate, refresh, and exit.
