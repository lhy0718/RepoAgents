...
from reporepublic.models import CURRENT_RUN_STATE_VERSION, RunLifecycle, RunRecord, RunStateFile
from reporepublic.models.domain import utc_now
from reporepublic.utils.files import ensure_dir, load_json_file, write_json_file


class RunStateMigrationError(RuntimeError):
    """Raised when RepoRepublic cannot migrate the persisted run state file."""
