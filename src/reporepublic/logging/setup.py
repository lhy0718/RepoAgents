...
def configure_logging(
    ...
    *,
    ...
    logger = logging.getLogger("reporepublic")
    ...
    if file_enabled:
        ...
        file_handler = logging.FileHandler(log_dir / "reporepublic.jsonl", encoding="utf-8")
...
def get_logger(name: str = "reporepublic") -> logging.Logger:
